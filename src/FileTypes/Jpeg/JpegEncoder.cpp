...
void FileParser::Jpeg::Encoder::countFrequencies(const std::vector<Coefficient>& coefficients, std::array<uint32_t, 256>& outFrequencies) {
    for (auto& coefficient : coefficients) {
        outFrequencies[coefficient.encoding]++;
    }
}

void FileParser::Jpeg::Encoder::generateCodeSizes(const std::array<uint32_t, 256>& frequencies, std::array<uint8_t, 257>& outCodeSizes) {
...
void FileParser::Jpeg::Encoder::adjustCodeSizes(std::array<uint8_t, 33>& codeSizeFrequencies) {
    uint32_t i = 32;
    while (true) {
...
void FileParser::Jpeg::Encoder::countCodeSizes(const std::array<uint8_t, 257>& codeSizes,
...
void FileParser::Jpeg::Encoder::countCodeSizes(const std::vector<HuffmanEncoding>& encodings,
    std::array<uint8_t, 33>& outCodeSizeFrequencies) {
    outCodeSizeFrequencies.fill(0);
...
void FileParser::Jpeg::Encoder::sortSymbolsByFrequencies(const std::array<uint32_t, 256>& frequencies, std::vector<uint8_t>& outSortedSymbols) {
...
void FileParser::Jpeg::Encoder::sortEncodingsByLength(const std::vector<HuffmanEncoding>& encodings,
